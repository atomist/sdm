...
export interface ChooseAndSetGoalsRules {
    ...
    preferencesMaker: PreferenceStoreMaker;
...
export async function chooseAndSetGoals(rules: ChooseAndSetGoalsRules,
    ...
    const { projectLoader, goalsListeners, goalSetter, implementationMapping, repoRefResolver, preferencesMaker } = rules;
    ...
    const preferences = preferencesMaker(parameters.context);
