 ...
 */
export type PreferenceStoreMaker = (ctx: HandlerContext) => PreferenceStore;
...
/**
 * NoOp PreferenceStore implementation useful for situations the SDM does not support preferences
 * or tests.
 */
